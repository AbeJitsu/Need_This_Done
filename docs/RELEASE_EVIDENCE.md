...
| Daily Desk signed-worker checkpoint | Focused test passed | Separate signed endpoints, fixed server-selected routing, cost reconciliation, capability declarations, and unsigned-request rejection are covered by local tests. No Mac installation or provider request occurred. |
