...
## Current Work page contract (2026-09-17)

The public Work page now owns capability breadth and one production proof. Services owns the two bounded starting offers, while Home stays an orientation page and the System remains optional technical detail. The public copy guard in `app/__tests__/public-language.test.ts` rejects illustrative, hypothetical, case-study-disclaimer, and “could look like” phrasing across the reviewed public surfaces.
