...
- The default MCP dispatcher creating durable workflows; it currently fails closed until the durable persistence adapter is connected.
...
- Hosted MCP secrets, hosted Redis, or remote MCP reachability.
