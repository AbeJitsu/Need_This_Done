-- A pending, additive model-evaluation record change. Do not apply this
-- migration to hosted Supabase without the separate backup rehearsal and
-- approval gate. OpenRouter owns model spend limits; this schema records the
-- provider-reported observations without imposing a local dollar ceiling.
