-- ============================================================================
-- MIGRATION 056: Fix Pre-Existing Function Bugs (SAFE VERSION)
-- ============================================================================
...
BEGIN
  IF EXISTS (
    ...
    WHERE routine_schema = 'public' AND routine_name = 'generate_quote_reference'
  ) THEN
    EXECUTE $sql$
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.routines
    WHERE routine_schema = 'public' AND routine_name = 'format_price'
  ) THEN
    EXECUTE $sql$
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.routines
    WHERE routine_schema = 'public' AND routine_name = 'get_product_rating'
  ) THEN
    EXECUTE $sql$
