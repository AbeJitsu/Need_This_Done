...
export TRANSACTIONAL_RESEND_PROVIDER=disabled
export PROSPECTING_RESEND_PROVIDER=disabled
export CALENDAR_PROVIDER=disabled
export STRIPE_INVOICE_PROVIDER=disabled
export RESEND_API_KEY=
export RESEND_ADMIN_EMAIL=
export RESEND_FROM_EMAIL=
export TRANSACTIONAL_RESEND_WEBHOOK_SECRET=
export PROSPECTING_RESEND_API_KEY=
export PROSPECTING_RESEND_WEBHOOK_SECRET=
...
export OPENROUTER_PRIMARY_MODEL=
export OPENROUTER_TEST_MODEL=
export OPENROUTER_BACKUP_MODEL=
