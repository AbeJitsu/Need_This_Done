  ...
  return (
    <button
      ...
      className={`w-full text-left rounded-xl border-2 p-4 transition-all duration-200
        ${selected ? 'border-emerald-500 bg-emerald-50 shadow-md shadow-emerald-500/10' : 'border-gray-200 bg-white hover:border-gray-300 hover:shadow-sm'}
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {selected && (
          <svg className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
