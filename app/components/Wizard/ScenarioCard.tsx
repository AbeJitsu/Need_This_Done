...
export default function ScenarioCard({ icon, title, description, selected, onClick }: ScenarioCardProps) {
  ...
  return (
    ...
    <motion.button
      ...
      className={`w-full text-left rounded-xl border-2 p-4 transition duration-200
      ...
      whileHover={prefersReducedMotion ? undefined : CARD_ANIMATION.hover}
      whileTap={prefersReducedMotion ? undefined : CARD_ANIMATION.tap}
