        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className={`absolute -top-1 -right-1 ${badgeColors.red} text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center leading-none pr-0.5 pt-0.5`}>
