...
export default function Navigation() {
  ...
  return (
    <nav aria-label="Main navigation" className="sticky top-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-600 dark:border-gray-700 shadow-sm">
      ...
      {mobileMenuOpen && (
        <div id="mobile-menu" className="lg:hidden border-t border-gray-600 dark:border-gray-700 bg-white dark:bg-gray-900">
          <nav aria-label="Mobile navigation" className="px-4 py-3 space-y-1">
            ...
            {!isAuthenticated ? (
              ...
              <div className="pt-2 mt-2 border-t border-gray-600 dark:border-gray-700">
