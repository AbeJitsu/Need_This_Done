...
import { FileText, Check, Mail, ArrowRight } from 'lucide-react';

// ============================================================================
// Terms Page Client - Bold Editorial Design
// ============================================================================
              ...
              <FadeIn direction="up" triggerOnScroll={false}>
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-8 h-1 rounded-full bg-gradient-to-r from-purple-400 to-slate-400" />
                  ...
                  <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white tracking-tight leading-[0.95] mb-4">
                    Terms of<br />
                    <span className="bg-gradient-to-r from-purple-400 via-slate-300 to-purple-400 bg-clip-text text-transparent">service.</span>
                  </h1>
                  ...
                  <FadeIn direction="up">
                    <div className="group">
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-6 h-1 rounded-full bg-gradient-to-r from-purple-500 to-slate-400 group-hover:w-8 transition-all duration-300" />
            ...
            <div className="mt-16 relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-10">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm bg-white text-gray-900 hover:bg-white/90 shadow-lg shadow-purple-500/20 transition-all duration-300 hover:-translate-y-1 whitespace-nowrap"
                >
                  <Mail size={18} />
