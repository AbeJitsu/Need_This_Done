    ...
    return (
      <div className={className}>
        ...
        <button
          type="button"
          onClick={handleClick}
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors"
        >
          ...
          {uploadingFiles.map(f => (
            ...
            >
              ...
              <div className="w-10 h-10 rounded-lg bg-gray-200 dark:bg-gray-700 flex items-center justify-center overflow-hidden flex-shrink-0">
                {f.media?.url ? (
                  <img src={f.media.url} alt="" className="w-full h-full object-cover" />
                ) : (
