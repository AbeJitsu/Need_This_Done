    ...
    >
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 text-sm border border-gray-400 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
      ...
      {/* Current selection */}
      <div className="mt-3 pt-3 border-t border-gray-400 dark:border-gray-700 flex items-center gap-2">
