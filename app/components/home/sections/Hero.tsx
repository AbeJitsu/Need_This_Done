  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* Main directional gradient: mathematically consistent smooth transitions */}
        <motion.div
          ...
          style={{
            backgroundImage: `linear-gradient(45deg,
              #a7f3d0 0%,
              #a7f3d0 12%,
              rgba(167, 243, 208, 0.7) 12.8%,
              rgba(167, 243, 208, 0.4) 14%,
              rgba(167, 243, 208, 0.1) 15.2%,
              white 16%,
              white 34%,
              rgba(191, 219, 254, 0.1) 34.8%,
              rgba(191, 219, 254, 0.4) 36%,
              rgba(191, 219, 254, 0.7) 37.2%,
              #bfdbfe 38%,
              #bfdbfe 50%,
              rgba(191, 219, 254, 0.7) 50.8%,
              rgba(191, 219, 254, 0.4) 52%,
              rgba(191, 219, 254, 0.1) 53.2%,
              white 54%,
              white 72%,
              rgba(216, 180, 254, 0.1) 72.8%,
              rgba(216, 180, 254, 0.4) 74%,
              rgba(216, 180, 254, 0.7) 75.2%,
              #d8b4fe 76%,
              #d8b4fe 88%,
              rgba(216, 180, 254, 0.7) 88.8%,
              rgba(216, 180, 254, 0.4) 90%,
              rgba(216, 180, 254, 0.1) 91.2%,
              white 92%,
              white 100%)`,
          }}
          animate={{
