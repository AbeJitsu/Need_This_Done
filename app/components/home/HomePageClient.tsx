...
import { OfferComparison, OutcomeFocusFlow, ThreeStepFlow } from '@/components/public/PublicServiceVisuals';
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-14 sm:px-8 md:py-20 lg:grid-cols-[.88fr_1.12fr] lg:px-12 lg:py-24">
          <div className="max-w-xl">
            ...
            <p className="mt-7 max-w-lg text-lg leading-8 text-[#50675e] md:text-xl">
              Bring us one website problem or one repeated problem at work. We agree on a clear outcome, do the contained work, and hand it back with a useful record.
            </p>
