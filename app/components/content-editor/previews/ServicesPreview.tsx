...
// ============================================================================
// What: Renders the Services page with provided content (not fetched)
// Why: Used in the content editor to show live preview of changes
// How: Same structure as the actual Services page, but takes content as props
// Note: Service cards come from siteConfig (not editable here)
