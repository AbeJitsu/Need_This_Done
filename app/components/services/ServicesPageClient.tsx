      ...
      <div className="min-h-screen">
        ...
        <section className="py-8 md:py-12">
          ...
          <div className="relative overflow-hidden md:max-w-6xl md:mx-auto md:rounded-2xl py-12 md:py-16 flex items-center justify-center min-h-[200px]">
            ...
            <div className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full bg-gradient-to-tr from-green-100 to-blue-100 blur-2xl" />
                    ...
                    <div className="flex gap-4 p-4 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <div>
                        <h3 className={`font-semibold text-white mb-1 ${
                          item.link ? 'group-hover:text-green-400 transition-colors' : ''
                        }`}>
                          {item.title}
                          {item.link && (
