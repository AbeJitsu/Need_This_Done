        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-10 md:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {skills.map((skill) => (
              <div
                key={skill.category}
                className="group relative p-6 rounded-2xl bg-white border border-stone-200 hover:border-stone-300 transition-all duration-300 hover:shadow-lg"
              >
                {/* Hover glow */}
              ...
              {experience.map((job) => {
                ...
                return (
                  <div key={`${job.company}-${job.title}`} className="relative pl-14 md:pl-18">
                    {/* Timeline dot */}
                    <div className={`absolute left-2 md:left-4 top-2 w-5 h-5 rounded-full ${colors.dot} ring-4 ring-white shadow-lg`} />
                    ...
                    <div className="group relative p-6 md:p-8 rounded-2xl bg-white border border-stone-200 hover:border-stone-300 transition-all duration-300 hover:shadow-lg">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-5">
                        ...
                        <span className={`inline-flex self-start px-4 py-1.5 text-sm font-semibold rounded-full border ${colors.badge}`}>
                          {job.period}
                        </span>
                      </div>
                      ...
                      <ul className="space-y-3">
                        {job.highlights.map((highlight, i) => (
                          <li key={i} className="flex items-start gap-3 text-base text-stone-600 leading-relaxed">
            ...
            <div>
              ...
              <div className="space-y-5">
                {education.map((edu) => (
                  <div
                    key={edu.institution}
                    className="p-6 rounded-2xl bg-white border border-stone-200"
                  >
              ...
              <div className="space-y-5">
                {[
                  ...
                  >
                    ...
                    <p className="text-base text-stone-700 italic leading-relaxed">&ldquo;{book.lesson}&rdquo;</p>
                  </div>
                ))}
              </div>
            </div>
