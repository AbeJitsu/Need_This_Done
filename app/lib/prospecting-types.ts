...
export interface ModelUsageLedgerEntry { id: string; task_id: string | null; usage_kind: 'benchmark' | 'research'; model_id: string; actual_model_id?: string | null; reserved_cost: number; actual_cost: number | null; status: 'reserved' | 'reconciled' | 'released'; local_usage_date: string; created_at: string; }
