...
export function createMcpWorkflowDispatcher(
  ...
  return {
    async startWorkflow(input: StartWorkflowInput, context: HermesMcpAuthContext) {
    ...
    async getWorkflowStatus(input: GetWorkflowStatusInput, context: HermesMcpAuthContext) {
    ...
    async listWorkflows(input: ListWorkflowsInput, context: HermesMcpAuthContext) {
