...
export const DEFAULT_LAYOUT_CONTENT: LayoutContent = {
  header: {
    ...
    navLinks: [
      { href: '/#example-day', label: 'How It Works' },
      { href: '/services', label: 'What It Handles' },
      { href: '/#example-day', label: 'Example Day' },
      { href: '/#outcomes', label: 'Outcomes' },
      { href: '/blog', label: 'Insights' },
    ],
    ctaButton: { text: 'Design My AI Employee', href: '/contact' },
    signInText: 'Sign in',
  },
  footer: {
    brand: 'Need This Done',
    tagline: 'Your AI Growth Employee works between check-ins and brings you the decisions that move the business forward.',
    links: [
      { href: '/#example-day', label: 'How It Works' },
      { href: '/services', label: 'What It Handles' },
      { href: '/#outcomes', label: 'Outcomes' },
      ...
      { href: '/contact', label: 'Design My AI Employee' },
    ],
    legalLinks: [
...
export const PAGE_CONFIGS = {
  ...
  faq: {
    ...
    defaults: {
      ...
      items: [
        { question: 'What do you build?', answer: 'We design and operate supervised AI Growth Employees that research, audit, prepare, prioritize, and track growth work between short check-ins.', links: [{ text: 'See what it handles', href: '/services' }] },
        { question: 'How much does it cost?', answer: 'The pilot and managed service are proposal-based while real pilot effort establishes reliable fixed prices. You receive a clear scope before work begins.', links: [{ text: 'See engagement stages', href: '/pricing' }] },
        ...
        { question: 'Can I start small?', answer: 'Yes. The pilot begins with a focused role, explicit guardrails, and a small set of measurable workflows. Capabilities expand only after the first loop is useful.' },
      ],
      cta: {
        title: 'Still Have Questions?',
        description: 'Book a quick call and we\'ll figure it out together.',
        buttons: [{ text: 'Book a Call', variant: 'purple', href: '/contact' }],
        hoverColor: 'purple',
      },
    } as FAQPageContent,
  },
  ...
  terms: {
    ...
    defaults: {
      ...
      sections: [
        ...
        { title: '2. Our Services', content: 'NeedThisDone designs and operates supervised AI Growth Employees. Work may include research, evidence-backed audits, prepared follow-up, prioritized decisions, and outcome tracking. Website improvements, integrations, or automation are scoped only when required by an approved growth plan.\n\nExternal communication, publishing, customer-system changes, and spending require explicit approval. Service availability and scope are defined in your proposal.' },
